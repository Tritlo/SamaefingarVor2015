...
\begin{frame}
  \begin{figure}[H]
    \centering
    \ifglaerur
    \input{GeoGebra/Mohr/Beamer/FaerslaLengdar.beamer.tex}
    \else
    \input{GeoGebra/Mohr/FaerslaLengdar.tex}
    \fi
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \ifglaerur
    \input{GeoGebra/Mohr/Beamer/SkpHringsOgLinu.beamer.tex}
    \else
    \input{GeoGebra/Mohr/SkpHringsOgLinu.tex}
    \fi
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \ifglaerur
    \input{GeoGebra/Mohr/Beamer/Midpstriks.beamer.tex}
    \else
...
\end{frame}
   \begin{frame}
     \begin{figure}[H]
       \centering
        \ifglaerur
        \input{GeoGebra/Mohr/Beamer/Sexhyrningur.beamer.tex}
        \else
        \input{GeoGebra/Mohr/Sexhyrningur.tex}
        \fi
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \ifglaerur
    \input{GeoGebra/Mohr/Beamer/SkpHringsOgMidjuLinu.beamer.tex}
    \else
    \input{GeoGebra/Mohr/SkpHringsOgMidjuLinu.tex}
    \fi
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \ifglaerur
    \input{GeoGebra/Mohr/Beamer/Thverill.beamer.tex}
    \else
    \input{GeoGebra/Mohr/Thverill.tex}
    \fi
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \input{GeoGebra/Mohr/ThverillEfQErALinunni.tex}
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \ifglaerur
        \input{GeoGebra/Mohr/Beamer/SkpTveggjaLina.beamer.tex}
    \else
        \input{GeoGebra/Mohr/SkpTveggjaLina.tex}
    \fi
...
\begin{frame}
  ...
  \begin{figure}[H]
    \centering
    \input{GeoGebra/Steiner/EkkiAllir.tex}
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \ifglaerur
    \input{GeoGebra/Steiner/Beamer/Samsida.tex}
    \else
    \input{GeoGebra/Steiner/Samsida.tex}
    \fi
...
\begin{frame}
  \begin{figure}[H]
    \centering
    \input{GeoGebra/Steiner/FaerslaLengdar.tex}
    \caption{Færsla lengdar}
